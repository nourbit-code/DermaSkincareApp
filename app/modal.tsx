    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.patientRow}>
          ...
          <View>
            ...
            <Text style={styles.patientInfo}>
              <Text style={styles.bold}>ID:</Text> {patient.id} | {patient.age} y/o |{" "}
              {patient.gender}
            </Text>
            <Text style={styles.patientInfo}>
            ...
            <Text style={styles.patientInfo}>
              <Text style={styles.bold}>Allergies:</Text> {patient.allergies}
            </Text>
            <Text style={styles.patientInfo}>
              <Text style={styles.bold}>Notes:</Text> {patient.notes}
            </Text>
          </View>
        </View>
        <View style={styles.actionRow}>
          ...
          <TouchableOpacity style={styles.primaryBtn}>
            ...
            <Text style={styles.primaryText}>Print</Text>
          </TouchableOpacity>
        </View>
      </View>
      ...
      <View style={styles.sectionHeader}>
        ...
        <TouchableOpacity
          style={styles.addBtn}
          onPress={() =>
            router.push({ pathname: "/doctor/diagnosis/[id]", params: { id: "new", patientId: patient.id } })
          }
        >
      ...
      {visits.map((v, i) => (
        <View key={v.id} style={[styles.card, { backgroundColor: serviceColor(v.service) }]}>
          ...
          >
            ...
            {expanded === i ? <ChevronUp size={20} color="#555" /> : <ChevronDown size={20} color="#555" />}
          </TouchableOpacity>
          ...
          {expanded === i && (
            <View style={styles.cardBody}>
              ...
              <Text>
                ...
                {v.diagnosis.complaint}
              </Text>
              <Text>
                <Text style={styles.bold}>Findings: </Text>
                {v.diagnosis.findings}
              </Text>
